   ...
   <div class="card card-xl-stretch mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">Leucine Statistics</span>
        {{-- <span class="text-muted fw-bold fs-7">More than 500 new orders</span> --}}
      </h3>
     <!--begin::Toolbar-->
     <div class="card-toolbar" data-kt-buttons="true">
      <a class="btn btn-sm btn-color-muted btn-active btn-active-primary active px-4 lgraph">weekly</a>
      <a class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4 me-1 lgraph ">monthly</a>
      <a class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4 me-1 lgraph">yearly</a>
    </div>
    <!--end::Toolbar-->
    </div>
    <!--end::Header-->
     ...
     <script>
        ...
        <script>
          ...
          var initialData = {
            ...
            series: JSON.parse(localStorage.getItem('leucine_sum')),
            yaxis: JSON.parse(localStorage.getItem('yaxis_maxl')),
          };
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var newData = {
            labels: JSON.parse(localStorage.getItem('label')),
            series: JSON.parse(localStorage.getItem('leucine_sum')),
            yaxis: parseInt(JSON.parse(localStorage.getItem('yaxis_maxl'))),
          };
          updateChart(newData);
        },
