                            ...
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full bg-warning is-dark">
                                    <div class="card-inner">
                                        ...
                                        <div class="fs-7 text-white text-opacity-75 mt-1"><span class="text-white">7</span>/10
                                            free drafts created</div>
                                    </div>
                                </div><!-- .card -->
                            </div><!-- .col -->
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full bg-info is-dark">
                                    <div class="card-inner">
                                        ...
                                        <div class="fs-7 text-white text-opacity-75 mt-1"><span class="text-white">4</span>/10
                                            free documents created</div>
                                    </div>
                                </div><!-- .card -->
                            </div><!-- .col -->
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full bg-danger is-dark">
                                    <div class="card-inner">
                                        ...
                                        <div class="fs-7 text-white text-opacity-75 mt-1"><span class="text-white">4</span>/16
                                            tools used to generate</div>
                                    </div>
                                </div><!-- .card -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="nk-tb-item">
                                        ...
                                        <td class="nk-tb-col">
                                            <div class="caption-text">The Impact of Artificial Intelligence on the Future of
                                                Work</div>
                                        </td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <div class="dropdown-content">
                                                        <ul class="link-list-opt no-bdr">
                                                            ...
                                                            <li>
                                                                <a href="#"><em class="icon ni ni-trash"></em><span>Move
                                                                        to Trash</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <tr class="nk-tb-item">
                                        ...
                                        <td class="nk-tb-col">
                                            <div class="caption-text">How to Boost Your Online Presence with Social Media
                                                Marketing</div>
                                        </td>
                                        <td class="nk-tb-col tb-col-sm">
                                    ...
                                    <tr class="nk-tb-item">
                                        ...
                                        <td class="nk-tb-col">
                                            <div class="caption-text">Top 10 Tips for Effective Time Management in the
                                                Workplace</div>
                                        </td>
                                        <td class="nk-tb-col tb-col-sm">
