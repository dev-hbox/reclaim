    ...
    init: function () {
        ...
        ! function () {
            ...
            function () {
                ...
                var yaxis_maxp = localStorage.getItem('yaxis_maxp');
                var yaxis_maxp = JSON.parse(yaxis_maxp);
                // console.log(yaxis_maxp, 'total Protein');

                var yaxis_maxl = localStorage.getItem('yaxis_maxl');
                var yaxis_maxl = JSON.parse(yaxis_maxl);
                // console.log(yaxis_maxl, 'total Leucine');

                var protein_sum = localStorage.getItem('protein_sum');
                var protein_sum = JSON.parse(protein_sum);
                // console.log(protein_sum, 'Protein Gain');

                var leucine_sum = localStorage.getItem('leucine_sum');
                var leucine_sum = JSON.parse(leucine_sum);
                // console.log(leucine_sum, 'Leucine Gain');
            ...
            function () {
                ...
                var e = document.getElementById("kt_charts_widget_0_chart"),
                    t = parseInt(KTUtil.css(e, "height")),
                    a = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.getCssVariableValue("--bs-gray-200"),
                    s = KTUtil.getCssVariableValue("--bs-warning"),
